  ...
  describe "POST #create" do
    ...
    context "with valid attributes" do
      it "saves the new car in the database" do
        ...
        scale = create(:scale)
        post :create, :params => { car: attributes_for(:car, scale_id: scale, user_id: user_id) }
    ...
    context "with invalid attributes" do
      it "does not save the new car in the database" do
        user_id = session[:user_id]
        post :create, :params => { car: attributes_for(:car, user_id: user_id) }
  ...
  describe "Update" do
    ...
    context "with valid value" do
      it "saves the new value in the database" do
        patch :update, params: { id: @car, car: attributes_for(:car, model: "Tesla")}
        @car.reload
    ...
    context "with invalid value" do
      it "don't save the new value in the database" do
        patch :update, params: { id: @car, car: attributes_for(:car, model: nil)}
